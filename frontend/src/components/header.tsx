  ...
  return (
    <Container>
      ...
      <ProfileDropdownContainer>
        <PcProfileDropdown history={history} user={user} />
      </ProfileDropdownContainer>
    </Container>
  );
};

export const Mobile: FC<HeaderProps> = ({history, user}) => {
  const Container = styled.div`
    width: 100vw;
    height: 60px;
    padding: 0 30px;
  ...
  return (
    <Container>
      ...
      <ProfileDropdownContainer>
        <MobileProfileDropdown history={history} user={user} />
      </ProfileDropdownContainer>
    </Container>
  );
};
...
const PcProfileDropdown: FC<ProfileDropdownProps> = ({history, user}) => {
...
const MobileProfileDropdown: FC<ProfileDropdownProps> = ({history, user}) => {
  const [showMenu, setShowMenu] = useState(false);
