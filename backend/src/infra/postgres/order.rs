...
pub trait PostgresOrderInfra {
    ...
    fn query_orders_by_market_id(&self, id: &Uuid) -> anyhow::Result<Option<QueryOrder>>;
}
...
impl PostgresOrderInfra for Postgres {
    ...
    fn query_orders_by_market_id(&self, id: &Uuid) -> anyhow::Result<Option<Vec<QueryOrder>>> {
        orders::table
